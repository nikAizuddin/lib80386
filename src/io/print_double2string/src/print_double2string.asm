...
.end_decimal_part_check_sign:
    ...
    ;    +----------------------------+
    ;----| 016: call print_int2string |---------------------------------
    ;    +----------------------------+
    ;       Write the decimal part into ascii string
    ;
    ;       print_int2string( decimal_part[0],
    ;                         @decimal_part_str[0],
    ;                         @decimal_part_strlen,
    ;                         0 );
    ;-------------------------------------------------------------------
...
;+----------------------------------------+
;| Write the integer part into out string |=============================
;+----------------------------------------+
;      For example:
;
...
;=======================================================================
    ...
    ;    +----------------------------+
    ;----| 021: Call print_int2string |---------------------------------
    ;    +----------------------------+
    ;       print_int2string( integer_part,
    ;                         addr_out_string,
    ;                         addr_out_strlen,
    ;                         1 );
    ;-------------------------------------------------------------------
...
;+---------------------------------------+
;| Append the decimal_part to out_string |==============================
;+---------------------------------------+
